...
qless-lib.lua: base.lua set.lua config.lua job.lua queue.lua recurring.lua worker.lua resource.lua
	echo "-- Current SHA: `git rev-parse HEAD`" > qless-lib.lua
	echo "-- This is a generated file" >> qless-lib.lua
	cat base.lua set.lua config.lua job.lua queue.lua recurring.lua worker.lua resource.lua >> qless-lib.lua
